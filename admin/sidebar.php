      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
         ...
         <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="add-match.php"><i class="fa fa-plus"></i>Add Match Info</a></li>
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-list"></i> <span>Match Booking Info</span>
            <i class="fa fa-angle-left pull-right"></i>
          </a>
          <ul class="treeview-menu">
            <li><a href="view-booking-info.php"><i class="fa fa-eye"></i>View Match Booking Info</a></li>
          </ul>
        </li>
