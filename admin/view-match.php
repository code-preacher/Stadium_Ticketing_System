     ...
     $lib->check_login2();
      ...
      if (isset($_GET['del'])) {
       $crud->delete($_GET['del'],'match_info','view-match.php');
     }

     if (isset($_GET['status'])) {
       $crud->updateMatchInfoStatus($_GET['status'],'view-match.php');
     }
                  ...
                  <div class="card-body">
                    <div class="table-responsive m-t-40">
                      <table id="example1" class="table table-bordered table-striped" cellspacing="0" width="100%">
                        ...
                        <tbody>
                         <?php
                           $qt=$crud->displayAllWithOrder('match_info','id','desc');
                         ...
                         <td><a href="view-match.php?status=<?php echo $dy['id']; ?>"><i class="fa fa-refresh text-primary"></i></a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="view-match.php?del=<?php echo $dy['id']; ?>" ><i class="fa fa-trash text-danger"></i></a></td>
